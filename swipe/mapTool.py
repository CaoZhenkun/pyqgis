...
class SwipeMapTool(QgsMapTool):
    def __init__(self, layerCombobox, mapCanvas):
        ...
        self.cursorSV = QCursor(QPixmap(os.path.join(here,
                                                     './images/split_v.png')))
        self.cursorSH = QCursor(QPixmap(os.path.join(here,
                                                     './images/split_h.png')))
        self.cursorUp = QCursor(QPixmap(os.path.join(here,
                                                     './images/up.png')))
        self.cursorDown = QCursor(QPixmap(os.path.join(here,
                                                       './images/down.png')))
        self.cursorLeft = QCursor(QPixmap(os.path.join(here,
                                                       './images/left.png')))
        self.cursorRight = QCursor(QPixmap(os.path.join(here,
                                                        './images/right.png')))
        self.cursorBox = QCursor(QPixmap(os.path.join(here,
                                                      './images/box.png')))
